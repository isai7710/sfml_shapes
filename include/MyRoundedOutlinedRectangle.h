#ifndef MYROUNDEDOUTLINEDRECTANGLE_H
#define MYROUNDEDOUTLINEDRECTANGLE_H
...
class MyRoundedOutlinedRectangle : public sf::Drawable {
public:
  MyRoundedOutlinedRectangle(const sf::Vector2f &p, const sf::Vector2f &size,
